...
import { addFavouriteCountries, removeFavouriteCountries, clearFavouriteCountries } from '../store/favouritesSlice';
    ...
    <Container className="my-5">
      ...
      <Row>
        <Col className="d-flex justify-content-center my-5">
          {countriesList.length > 0 && (
            <Button variant="danger" onClick={() => dispatch(clearFavouriteCountries())}>
